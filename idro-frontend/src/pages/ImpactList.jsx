import { Activity, AlertTriangle, ArrowRight, BarChart3, XCircle } from "lucide-react";
            ...
            >
              ...
              <div className="relative z-10 space-y-4">
                <div className="flex justify-between items-start">
                  <span className={`text-[10px] font-bold uppercase tracking-widest px-2 py-1 rounded border ${disaster.color === 'RED' ? 'bg-red-500/10 text-red-400 border-red-500/30' : 'bg-orange-500/10 text-orange-400 border-orange-500/30'
                    }`}>
                    {disaster.type}
                  </span>
