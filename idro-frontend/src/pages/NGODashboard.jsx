...
export default function NGODashboard() {
    ...
    const ResourceCheckbox = ({ category, resourceKey, label, icon }) => {
        const resources = {
            relief: reliefSupplies,
            medical: medicalSupport,
            shelter: shelterEssentials,
            human: humanResources
        };

        const resource = resources[category]?.[resourceKey] || { available: false, quantity: 0 };
        ...
        return (
            <div className="flex items-center gap-3 p-3 bg-black/20 rounded border border-white/5 hover:border-white/10 transition-colors">
                <input
                    ...
                    onChange={(e) => handleResourceChange(category, resourceKey, 'available', e.target.checked)}
                ...
                <input
                    ...
                    onChange={(e) => handleResourceChange(category, resourceKey, 'quantity', e.target.value)}
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-[#1e293b] border border-white/10 rounded-xl p-6 shadow-xl">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <ResourceCheckbox category="relief" resourceKey="foodPackets" label="Food Packets" icon="🍱" />
                                <ResourceCheckbox category="relief" resourceKey="drinkingWater" label="Drinking Water" icon="💧" />
                                <ResourceCheckbox category="relief" resourceKey="sanitaryKits" label="Sanitary Kits" icon="🧼" />
                            </div>
                        </div>
                        ...
                        <div className="bg-[#1e293b] border border-white/10 rounded-xl p-6 shadow-xl">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <ResourceCheckbox category="medical" resourceKey="firstAidKits" label="First Aid Kits" icon="🩹" />
                                <ResourceCheckbox category="medical" resourceKey="doctors" label="Doctors" icon="👨‍⚕️" />
                                <ResourceCheckbox category="medical" resourceKey="nurses" label="Nurses" icon="👩‍⚕️" />
                                <ResourceCheckbox category="medical" resourceKey="ambulances" label="Ambulances" icon="🚑" />
                            </div>
                        </div>
                        ...
                        <div className="bg-[#1e293b] border border-white/10 rounded-xl p-6 shadow-xl">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <ResourceCheckbox category="shelter" resourceKey="tents" label="Tents" icon="⛺" />
                                <ResourceCheckbox category="shelter" resourceKey="blankets" label="Blankets" icon="🛏️" />
                                <ResourceCheckbox category="shelter" resourceKey="clothes" label="Clothes" icon="👕" />
                            </div>
                        </div>
                        ...
                        <div className="bg-[#1e293b] border border-white/10 rounded-xl p-6 shadow-xl">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <ResourceCheckbox category="human" resourceKey="volunteers" label="Volunteers" icon="🙋" />
                                <ResourceCheckbox category="human" resourceKey="rescueWorkers" label="Rescue Workers" icon="🦺" />
                            </div>
                        </div>
